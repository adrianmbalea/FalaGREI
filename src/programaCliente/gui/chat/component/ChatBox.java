...
import programaCliente.gui.chat.swing.AutoWrapText;
import programaCliente.gui.chat.swing.ImageAvatar;
...
public class ChatBox extends JComponent {
    ...
    protected void paintComponent(Graphics g) {
        ...
        if (boxType == BoxType.LEFT) {
            ...
            g2.setPaint(new GradientPaint(0, 0, new Color(85, 216, 147), width, 0, new Color(105, 236, 167, 255)));
            g2.fill(area);
        } else {
            ...
            g2.setPaint(new GradientPaint(0, 0, new Color(90, 182, 255), width, 0, new Color(110, 202, 255, 255)));
            g2.fill(area);
        }
        g2.dispose();
